...
class CategoryController extends \yii\web\Controller {
    ...
    public function actionIndex($name = null) {
        ...
        $models2 = Category::find()->where(['catetags' => 'category'])->asArray()->all();
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($models->save()) {
                ShowMsg("数据添加成功", \yii\helpers\Url::to(['category/index']));
            } else {
...
<<<<<<< .mine
        ...
        if (isset($_POST['submit']) && $models->validate()) {
            ...
            if ($models->save()) {
                ...
                ShowMsg("数据更新成功", \yii\helpers\Url::to(['category/index']));
            } else {
...
//		$num2 = Category::deleteAll(['id'=>$ids]);
        if ($num > 0) {
            ShowMsg("数据删除成功", \yii\helpers\Url::to(['category/index']));
        }
    }
